...
const propertyCard = ({ property }) => {
    ...
    return (
        ...
        //     <div className="max-w-[300px] lg:min-w-[350px] lg:max-w-[350px] bg-white overflow-hidden relative">
        //         {/* image div */}
        //         <Link
        ...
        //             </div>
        //             {/* title */}
        //             <h1 className="font-bold lg:text-xl text-xl">{property.p_name}</h1>
        //             {/* price */}
        ...
        //                         className="bg-cyan-700 font-semibold text-white px-3 py-1 text-sm hover:bg-white border hover:text-cyan-600"
        //                     >
        //                         Edit
        //                     </Link>
        //                     <button
