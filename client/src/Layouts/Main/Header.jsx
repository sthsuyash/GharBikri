...
function Header() {
    return (
        <Fragment className="bg-white">
            ...
            {/* main div */}
            <div className="mx-auto max-w-full justify-normal px-4 lg:px-16 md:px-8 md:flex-row flex-col flex lg:flex-row flex-wrap lg:my-16 my-10">

                {/* left div */}
                <div className="lg:w-2/4 md:w-2/4">
                    <h1 className="text-6xl font-extrabold tracking-tight leading-none text-gray-900 md:text-6xl lg:text-8xl ">Let&apos;s Find Your Comfort <span className="text-blue-500">House!</span></h1>
                </div>
                ...
                <div className="flex flex-col lg:w-2/4 md:w-2/4 justify-start space-y-10">
                    ...
                    <div>
                        <h2 className="capitalize text-gray-400 text-xl lg:my-2 my-5">Find comfort in the house with us, want to find a home? we are ready to help you wholeheartedly based on what you need</h2>
